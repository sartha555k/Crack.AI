...
app=FastAPI(title="AI Interviewer Microservice(Fastapi)",version="1.0")
...
async def generate_question(request: QuestionRequest):
    ...
    try:
        ...
        system_prompt = (
            ...
            "CRITICAL: Do NOT include introductory phrases. "
            "Start immediately with the question body. "
            "Each item inside questions array MUST be a STRING only. "
            "Do NOT return objects like {'question':'...'} "
            f"Instructions: {instruction} "
            "Respond ONLY with valid JSON containing a 'questions' array."
        )
